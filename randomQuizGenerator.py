#！ python3
# randomQuizGenerator.py  - Creates quiezzes with questions and answers in
...
if not os.path.exists('.\\quiezzes'):
    os.makedirs('.\\quiezzes')
    os.chdir('.\\quiezzes')
    print('Change cwd to .\\quiezzes')
else:
    print('You have quiezzes already.')
    sys.exit()
